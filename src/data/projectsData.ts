export const projectsData = [
  ...
  },
  {
    ...
    "textContent": {
      "blocks": [
        "Localhost is a VS Code-inspired platform built for CSI VIT's 2024 organizing committee selections. With its familiar code-editor interface, the platform streamlines the entire recruitment process from application submission to candidate evaluation.",
        "The system provides organizing teams with efficient tools to assess prospective members while creating an engaging, developer-friendly experience for applicants. By reimagining familiar development environments for organizational processes, Localhost demonstrates innovative thinking in recruitment technology tailored specifically for the tech-savvy CSI community."
      ]
    },
    "buttons": {
      "primary": {
  ...
  },
  {
    ...
    "textContent": {
      "blocks": [
        "OCS is CSI VIT's 2025 organizing committee selection portal featuring a sleek macOS-inspired interface that transforms recruitment into an interactive desktop experience. The platform showcases the chapter's projects, events, and memories while allowing you to enjoy mini-games like CSI Draw, Doom, and 2048.",
